...
class ChooseActivityLvl5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_lvl5)
        ////////
        bgImageView = findViewById(R.id.bgActivityChooseLvlP5)
        ...
        imageButtonsLvl = arrayOf(
            findViewById(R.id.ezAct1l5),
            findViewById(R.id.midAct1l5),
            findViewById(R.id.hdAct1l5),
        )
                        ...
                        return try {
                            ...
                            val resultMessage = if (resultSet.next()) {
                                ...
                                val intent =  when (index) {
                                    0 -> Intent(this@ChooseActivityLvl5, GameActivityEzPc5::class.java)
                                    1 -> Intent(this@ChooseActivityLvl5, GameActivityMdPc5::class.java)
                                    2 -> Intent(this@ChooseActivityLvl5, GameActivityHdPc5::class.java)
        ...
        randomChoosePc3.setOnClickListener {
            ...
            val intentRandom = when (randomIndex){
                0 -> Intent(this, GameActivityEzPc5::class.java)
                1 -> Intent(this, GameActivityMdPc5::class.java)/////////////////
                2 -> Intent(this, GameActivityHdPc5::class.java)
                else -> throw IllegalArgumentException("Invalid button index")
            }
            startActivity(intentRandom)
        }
        val backBtn: ImageButton = findViewById(R.id.backBtnnl5)
