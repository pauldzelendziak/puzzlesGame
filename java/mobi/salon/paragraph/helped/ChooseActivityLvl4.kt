...
class ChooseActivityLvl4 : AppCompatActivity() {
    private lateinit var serviceIntent: Intent
    private lateinit var musicService: MusicService
    private var isActivityCheck = true
    private var isMusicOn = false
    private lateinit var randomChoosePc3: ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_lvl4)
        ////////
        bgImageView = findViewById(R.id.bgActivityChooseLvlP4)
        ...
        imageButtonsLvl = arrayOf(
            findViewById(R.id.ezAct1l4),
            findViewById(R.id.midAct1l4),
            findViewById(R.id.hdAct1l4),
        )
        randomChoosePc3 = findViewById(R.id.randomBtnLvl1Pc4)
            ...
            button.setOnClickListener {
                ...
                object : AsyncTask<Void, Void, String>() {
                    ...
                    override fun doInBackground(vararg params: Void?): String {
                        return try {
                            ...
                            val connection = DriverManager.getConnection(
                                "jdbc:mysql://10.0.2.2:3306/game4cr", // Замість 10.0.2.2 поставте ваш сервер MySQL
                                "root",
                                "root"
                            )
                            ...
                            preparedStatement.setInt(1, id) // Реальний user_id
                            preparedStatement.setString(2, gameDifficultList[index].toString()) // Записуємо режим гри
                            ...
                            preparedStatement2.setInt(1, id) // Реальний user_id
                            val resultSet: ResultSet = preparedStatement2.executeQuery()

                            // Обробка результатів
                            val resultMessage = if (resultSet.next()) {
                                val maxId = resultSet.getInt("max_id") // Витягуємо значення стовпця "max_id"

                                // Передаємо ID через Intent
                                val intent =  when (index) {
                                    0 -> Intent(this@ChooseActivityLvl4, GameActivityEzPc4::class.java)
                                    1 -> Intent(this@ChooseActivityLvl4, GameActivityMdPc4::class.java)
                                    2 -> Intent(this@ChooseActivityLvl4, GameActivityHdPc4::class.java)
                    ...
                    override fun onPostExecute(result: String) {
                        ...
                        Log.d("MyLog", result) // Виведення результату
                    }
                }.execute()
        ...
        randomChoosePc3.setOnClickListener {
            val randomIndex = Random.nextInt(3)
            val intentRandom = when (randomIndex){
                0 -> Intent(this, GameActivityEzPc4::class.java)
                1 -> Intent(this, GameActivityMdPc4::class.java)
                2 -> Intent(this, GameActivityHdPc4::class.java)
                else -> throw IllegalArgumentException("Invalid button index")
            }
            startActivity(intentRandom)
        }
        val backBtn: ImageButton = findViewById(R.id.backBtnnl4)
