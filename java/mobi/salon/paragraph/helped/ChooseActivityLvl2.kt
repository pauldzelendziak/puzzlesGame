...
class ChooseActivityLvl2 : AppCompatActivity() {
    private lateinit var serviceIntent: Intent
    private lateinit var musicService: MusicService
    private var isActivityCheck = true
    private var isMusicOn = false
    private lateinit var randomChoosePc2: ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_lvl2)
        ////////
        bgImageView = findViewById(R.id.bgActivityChooseLvlP2)
        ...
        imageButtonsLvl = arrayOf(
            findViewById(R.id.ezAct1l2),
            findViewById(R.id.midAct1l2),
            findViewById(R.id.hdAct1l2),
        )

        randomChoosePc2 = findViewById(R.id.randomBtnLvl1Pc2)
        ...
        val backBtn: ImageButton = findViewById(R.id.backBtnnl2)
                        ...
                        return try {
                            ...
                            val resultMessage = if (resultSet.next()) {
                                ...
                                val intent =  when (index) {
                                    0 -> Intent(this@ChooseActivityLvl2, GameActivityEzPc2::class.java)
                                    1 -> Intent(this@ChooseActivityLvl2, GameActivityMdPc2::class.java)
                                    2 -> Intent(this@ChooseActivityLvl2, GameActivityHdPc2::class.java)
        ...
        randomChoosePc2.setOnClickListener {
            val randomIndex = Random.nextInt(3)
            val intentRandom = when (randomIndex){
                0 -> Intent(this, GameActivityEzPc2::class.java)
                1 -> Intent(this, GameActivityMdPc2::class.java)
                2 -> Intent(this, GameActivityHdPc2::class.java)
                else -> throw IllegalArgumentException("Invalid button index")
            }
