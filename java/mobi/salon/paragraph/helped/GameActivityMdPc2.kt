...
class GameActivityMdPc2 : AppCompatActivity() {
    private lateinit var puzzlesOnDesk_p2: Array<ImageView>
    private lateinit var puzzlesGr_p2: Array<ImageView>
    ...
    //////////////////////////////////////////
    private lateinit var timerMdPc2: TextView
    private val timerHelper = TimerHelper()
    private var score: Int = 0
    private var startTime: Long = 0
    private var endTime: Long = 0
    private lateinit var hintMdPc2: ImageButton
    private lateinit var btnWithTpMdP3: ImageButton
    private lateinit var btnWithoutTpMdP3: ImageButton
    private lateinit var counterMdPc2: TextView
    private var recivedData : Int = -1
    private lateinit var pauseBgMdPc2: ImageView
    private lateinit var textChooseM1MdPc2: TextView
    private lateinit var textChooseM2MdPc2: TextView
    ////////
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_game_mid_pc2)
        hideUi()
        recivedData = intent.getIntExtra("extra_data", -1)
        ////////
        bgImageView = findViewById(R.id.bgActGameMdPc2)
        ...
        val backBtn: ImageButton = findViewById(R.id.backMdPc2)
        ...
        //////////////////////////////////////
        hintMdPc2 = findViewById(R.id.hintMdPc2)
        hintMdPc2.isEnabled = false
        counterMdPc2 = findViewById(R.id.counterMdPc2)
        //////////////////////////////////////////
        ...
        puzzlesOnDesk_p2 = arrayOf(
            findViewById(R.id.p2_md_im1),
            findViewById(R.id.p2_md_im2),
            findViewById(R.id.p2_md_im3),
            findViewById(R.id.p2_md_im4),
            findViewById(R.id.p2_md_im5),
            findViewById(R.id.p2_md_im6),
            findViewById(R.id.p2_md_im7),
            findViewById(R.id.p2_md_im8),
            findViewById(R.id.p2_md_im9),
            findViewById(R.id.p2_md_im10),
            findViewById(R.id.p2_md_im11),
            findViewById(R.id.p2_md_im12),
            findViewById(R.id.p2_md_im13),
            findViewById(R.id.p2_md_im14),
            findViewById(R.id.p2_md_im15),
            findViewById(R.id.p2_md_im16),
            findViewById(R.id.p2_md_im17),
            findViewById(R.id.p2_md_im18),
            findViewById(R.id.p2_md_im19),
            findViewById(R.id.p2_md_im20),
            findViewById(R.id.p2_md_im21),
            findViewById(R.id.p2_md_im22),
            findViewById(R.id.p2_md_im23),
            findViewById(R.id.p2_md_im24),
            findViewById(R.id.p2_md_im25),
            findViewById(R.id.p2_md_im26),
            findViewById(R.id.p2_md_im27),
            findViewById(R.id.p2_md_im28),
            findViewById(R.id.p2_md_im29),
            findViewById(R.id.p2_md_im30),
            findViewById(R.id.p2_md_im31),
            findViewById(R.id.p2_md_im32),
            findViewById(R.id.p2_md_im33),
            findViewById(R.id.p2_md_im34),
            findViewById(R.id.p2_md_im35),
            findViewById(R.id.p2_md_im36),
            findViewById(R.id.p2_md_im37),
            findViewById(R.id.p2_md_im38),
            findViewById(R.id.p2_md_im39),
            findViewById(R.id.p2_md_im40),
            findViewById(R.id.p2_md_im41),
            findViewById(R.id.p2_md_im42),
            findViewById(R.id.p2_md_im43),
            findViewById(R.id.p2_md_im44),
            findViewById(R.id.p2_md_im45),
            findViewById(R.id.p2_md_im46),
            findViewById(R.id.p2_md_im47),
            findViewById(R.id.p2_md_im48),
        )
        puzzlesGr_p2 = arrayOf(
            findViewById(R.id.p2_md_imgr1),
            findViewById(R.id.p2_md_imgr2),
            findViewById(R.id.p2_md_imgr3),
            findViewById(R.id.p2_md_imgr4),
            findViewById(R.id.p2_md_imgr5),
            findViewById(R.id.p2_md_imgr6),
            findViewById(R.id.p2_md_imgr7),
            findViewById(R.id.p2_md_imgr8),
            findViewById(R.id.p2_md_imgr9),
            findViewById(R.id.p2_md_imgr10),
            findViewById(R.id.p2_md_imgr11),
            findViewById(R.id.p2_md_imgr12),
            findViewById(R.id.p2_md_imgr13),
            findViewById(R.id.p2_md_imgr14),
            findViewById(R.id.p2_md_imgr15),
            findViewById(R.id.p2_md_imgr16),
            findViewById(R.id.p2_md_imgr17),
            findViewById(R.id.p2_md_imgr18),
            findViewById(R.id.p2_md_imgr19),
            findViewById(R.id.p2_md_imgr20),
            findViewById(R.id.p2_md_imgr21),
            findViewById(R.id.p2_md_imgr22),
            findViewById(R.id.p2_md_imgr23),
            findViewById(R.id.p2_md_imgr24),
            findViewById(R.id.p2_md_imgr25),
            findViewById(R.id.p2_md_imgr26),
            findViewById(R.id.p2_md_imgr27),
            findViewById(R.id.p2_md_imgr28),
            findViewById(R.id.p2_md_imgr29),
            findViewById(R.id.p2_md_imgr30),
            findViewById(R.id.p2_md_imgr31),
            findViewById(R.id.p2_md_imgr32),
            findViewById(R.id.p2_md_imgr33),
            findViewById(R.id.p2_md_imgr34),
            findViewById(R.id.p2_md_imgr35),
            findViewById(R.id.p2_md_imgr36),
            findViewById(R.id.p2_md_imgr37),
            findViewById(R.id.p2_md_imgr38),
            findViewById(R.id.p2_md_imgr39),
            findViewById(R.id.p2_md_imgr40),
            findViewById(R.id.p2_md_imgr41),
            findViewById(R.id.p2_md_imgr42),
            findViewById(R.id.p2_md_imgr43),
            findViewById(R.id.p2_md_imgr44),
            findViewById(R.id.p2_md_imgr45),
            findViewById(R.id.p2_md_imgr46),
            findViewById(R.id.p2_md_imgr47),
            findViewById(R.id.p2_md_imgr48),
        )
        puzzlesOnDesk_p2.forEach { puzzle ->
            puzzle.setOnTouchListener(null)
        }
        /////////////////////////////////////////////
        hintMdPc2.setOnClickListener {
            if (score >= 4) {
                score -= 4
                counterMdPc2.text = score.toString()
                showHintImage()
                hintMdPc2.isEnabled = false
            } else {
            }
        ...
        pauseBgMdPc2 = findViewById(R.id.foneMdPc2)
        btnWithTpMdP3 = findViewById(R.id.btn_WithTpMdPc2)
        btnWithoutTpMdP3 = findViewById(R.id.btn_WithoutTpMdPc2)
        timerMdPc2 = findViewById(R.id.timer_Md_pc2)
        textChooseM1MdPc2 = findViewById(R.id.textChooseM1MdPc2)
        textChooseM2MdPc2 = findViewById(R.id.textChooseM2MdPc2)
        ChooseMode()
        //////////////////////////////////////////////////////////////
    }
    ...
    private fun handleTouch(view: View, motionEvent: MotionEvent): Boolean {
        ...
        when (motionEvent.action) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                puzzlesOnDesk_p2.forEach { deskPuzzle ->
                    puzzlesGr_p2.forEach { grPuzzle ->
    ...
    private fun ChooseMode(){
        btnWithTpMdP3.setOnClickListener {
            ...
            pauseBgMdPc2.isVisible = false
            textChooseM1MdPc2.isVisible = false
            textChooseM2MdPc2.isVisible = false
            timerHelper.startTimer(timerMdPc2)
        }
    ...
    private fun showHintImage() {
        val hintImageView: ImageView = findViewById(R.id.hintImgMdPc2)
    ...
    fun animateImageSize10() {
        val animImageEzPc4: ImageView = findViewById(R.id.animImgMdPc2)
        animImageEzPc4.isVisible = true
        puzzlesGr_p2.forEach { puzzle ->
    ...
    private fun isGameCompleted(): Boolean {
        val isCompleted = puzzlesOnDesk_p2.all { !it.isVisible }
