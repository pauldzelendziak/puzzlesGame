...
class ChooseActivityLvl3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_choose_lvl3)
        ////////
        bgImageView = findViewById(R.id.bgActivityChooseLvlP3)
        ...
        imageButtonsLvl = arrayOf(
            findViewById(R.id.ezAct1l3),
            findViewById(R.id.midAct1l3),
            findViewById(R.id.hdAct1l3),
        )
        randomChoosePc3 = findViewById(R.id.randomBtnLvl1Pc3)
                        ...
                        return try {
                            ...
                            val resultMessage = if (resultSet.next()) {
                                ...
                                val intent =  when (index) {
                                    0 -> Intent(this@ChooseActivityLvl3, GameActivityEzPc3::class.java)
                                    1 -> Intent(this@ChooseActivityLvl3, GameActivityMdPc3::class.java)
                                    2 -> Intent(this@ChooseActivityLvl3, GameActivityHdPc3::class.java)
        ...
        val backBtn: ImageButton = findViewById(R.id.backBtnnl3)
