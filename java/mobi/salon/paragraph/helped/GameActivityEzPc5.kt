...
class GameActivityEzPc5 : AppCompatActivity() {
    private lateinit var serviceIntent: Intent
    private lateinit var musicService: MusicService
    private var isActivityCheck = true
    private var isMusicOn = false
    private lateinit var puzzlesOnDeskp5ez: Array<ImageView>
    private lateinit var puzzlesGrp5ez: Array<ImageView>
    private lateinit var hintEzPc5: ImageButton
    private lateinit var btnWithTp: ImageButton
    private lateinit var btnWithoutTp: ImageButton
    private lateinit var pauseBgEzPc5: ImageView
    private lateinit var counterEzPc5: TextView
    private lateinit var textChooseM1EzPc5: TextView
    private lateinit var textChooseM2EzPc5: TextView
    private lateinit var timerEzPc5: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_game_ez_pc5)
        hideUi()
        ...
        val backBtn: ImageButton = findViewById(R.id.backEzPc5)
        hintEzPc5 = findViewById(R.id.hintEzPc5)
        hintEzPc5.isEnabled = false
        counterEzPc5 = findViewById(R.id.counterEzPc5)
        ...
        textChooseM1EzPc5 = findViewById(R.id.textChooseM1EzPc5)
        textChooseM2EzPc5 = findViewById(R.id.textChooseM2EzPc5)
        layoutParams.screenBrightness = Brigthness
        window.attributes = layoutParams
        puzzlesOnDeskp5ez = arrayOf(
            findViewById(R.id.ez_p5_im1),
            findViewById(R.id.ez_p5_im2),
            findViewById(R.id.ez_p5_im3),
            findViewById(R.id.ez_p5_im4),
            findViewById(R.id.ez_p5_im5),
            findViewById(R.id.ez_p5_im6),
            findViewById(R.id.ez_p5_im7),
            findViewById(R.id.ez_p5_im8),
            findViewById(R.id.ez_p5_im9),
            findViewById(R.id.ez_p5_im10),
            findViewById(R.id.ez_p5_im11),
            findViewById(R.id.ez_p5_im12),
            findViewById(R.id.ez_p5_im13),
            findViewById(R.id.ez_p5_im14),
            findViewById(R.id.ez_p5_im15),
            findViewById(R.id.ez_p5_im16),
            findViewById(R.id.ez_p5_im17),
            findViewById(R.id.ez_p5_im18),
            findViewById(R.id.ez_p5_im19),
            findViewById(R.id.ez_p5_im20),
            findViewById(R.id.ez_p5_im21),
            findViewById(R.id.ez_p5_im22),
            findViewById(R.id.ez_p5_im23),
            findViewById(R.id.ez_p5_im24),
        )
        puzzlesGrp5ez = arrayOf(
            findViewById(R.id.ez_p5_imgr1),
            findViewById(R.id.ez_p5_imgr2),
            findViewById(R.id.ez_p5_imgr3),
            findViewById(R.id.ez_p5_imgr4),
            findViewById(R.id.ez_p5_imgr5),
            findViewById(R.id.ez_p5_imgr6),
            findViewById(R.id.ez_p5_imgr7),
            findViewById(R.id.ez_p5_imgr8),
            findViewById(R.id.ez_p5_imgr9),
            findViewById(R.id.ez_p5_imgr10),
            findViewById(R.id.ez_p5_imgr11),
            findViewById(R.id.ez_p5_imgr12),
            findViewById(R.id.ez_p5_imgr13),
            findViewById(R.id.ez_p5_imgr14),
            findViewById(R.id.ez_p5_imgr15),
            findViewById(R.id.ez_p5_imgr16),
            findViewById(R.id.ez_p5_imgr17),
            findViewById(R.id.ez_p5_imgr18),
            findViewById(R.id.ez_p5_imgr19),
            findViewById(R.id.ez_p5_imgr20),
            findViewById(R.id.ez_p5_imgr21),
            findViewById(R.id.ez_p5_imgr22),
            findViewById(R.id.ez_p5_imgr23),
            findViewById(R.id.ez_p5_imgr24),
        )
        puzzlesOnDeskp5ez.forEach { puzzle ->
            puzzle.setOnTouchListener(null)
        }
        hintEzPc5.setOnClickListener {
            if (score >= 4) {
                score -= 4
                counterEzPc5.text = score.toString()
                showHintImage()
                hintEzPc5.isEnabled = false
            } else {
            }
        ...
        pauseBgEzPc5 = findViewById(R.id.foneEzPc5)
        btnWithTp = findViewById(R.id.btn_WithTpEzPc5)
        btnWithoutTp = findViewById(R.id.btn_WithoutTpEzPc5)
        timerEzPc5 = findViewById(R.id.timer_Ez_pc5)
        ChooseMode()
    }
    ...
    private fun handleTouch(view: View, motionEvent: MotionEvent): Boolean {
        ...
        when (motionEvent.action) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                puzzlesOnDeskp5ez.forEach { deskPuzzle ->
                    puzzlesGrp5ez.forEach { grPuzzle ->
    ...
    private fun ChooseMode(){
        btnWithTp.setOnClickListener {
            ...
            pauseBgEzPc5.isVisible = false
            textChooseM1EzPc5.isVisible = false
            textChooseM2EzPc5.isVisible = false
            timerHelper.startTimer(timerEzPc5)
        }
    ...
    private fun showHintImage() {
        val hintImageView: ImageView = findViewById(R.id.hintImgEzPc5)
    ...
    fun animateImageSize4() {
        val animImageEzPc4: ImageView = findViewById(R.id.AnimImgEzPc5)
    ...
    private fun isGameCompleted(): Boolean {
        val isCompleted = puzzlesOnDeskp5ez.all { !it.isVisible }
